document.addEventListener('DOMContentLoaded', function() {
    const ventasZapatos = JSON.parse(localStorage.getItem('ventasZapatos')) || [];
    ...
    function filterVentas() {
        ...
        const filteredVentas = ventasZapatos.filter(venta => {
            return (
    ...
    function editVenta(index) {
        const venta = ventasZapatos[index];
